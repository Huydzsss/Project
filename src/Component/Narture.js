  ...
  return (
    <div>
      ...
      <div className="d-flex justify-content-center align-items-center">
        <h1 style={{ fontSize: "60px" }}>Nature</h1>
      </div>
      <div className="image">
        <img
        ...
        <div className="container">
          <h2 style={{ fontSize: "30px" }}>Zootopia incredible biodiversity is recognized all over the world.</h2>
          <p>
      ...
      <div className="container">
        <h2 style={{ fontSize: "30px" }}>Recommend with nature in Zootopia</h2>
        <div className="d-flex justify-content-center flex-row">
          <div className="card" style={{ width: "18rem", margin: "10px" }}>
            ...
            <div className="card-body">
              ...
              <NavLink to="/Animals" className="btn btn-primary">
                See more
              </NavLink>
            </div>
          </div>
          ...
          <div className="card" style={{ width: "18rem", margin: "10px" }}>
            ...
            <div className="card-body">
              ...
              <NavLink to="/Plants" className="btn btn-primary">
                See more
              </NavLink>
            </div>
          </div>
