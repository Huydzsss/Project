      ...
      <section className="my-0 bg-warning mt-1">
          ...
          <div className="d-flex justify-content-center flex-row container-fluid bg-warning">
            <div className="img-wrapper ">
              <img className="img-thumbnail " src={`${process.env.PUBLIC_URL}/${animal.gallery1}`} style={{ height: "500px", width: "500px" }} />
            </div>
            <div className="img-wrapper ">
              <img className="img-thumbnail " src={`${process.env.PUBLIC_URL}/${animal.gallery2}`} style={{ height: "500px", width: "500px" }} />
            </div>
          </div>
        </section>
      <Footer/>
